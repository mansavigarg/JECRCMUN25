  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-white flex flex-col mt-24">
        <div
          className="w-full h-[30vh] sm:h-[38vh] flex flex-col items-center justify-center"
          style={{
        ...
        >
          <motion.h1 className="text-4xl sm:text-6xl md:text-7xl font-bold text-[#991C1C] tracking-wide uppercase shadow-lg">
            JECRCMUN
          </motion.h1>
          <h2 className="text-2xl sm:text-4xl font-bold text-[#000000] mt-2 sm:mt-4">
            Our Team
          </h2>
        </div> */}
