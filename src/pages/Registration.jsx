...
const Registration = () => {
  ...
  const roles = [
    {
      ...
      committees: ["UNSC", "ECOFIN", "UNHCR", "COPUOS", "AIPPM", "SICCC", "CBFC", "IP"]
    },
    {
      title: "Observer",
      fee: "₹2500",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#ffffff] via-[#ffff] to-[#ffffff] py-16 px-4 relative overflow-hidden">
              ...
              <div className={`rounded-xl overflow-hidden shadow-2xl bg-white ${
                ...
                <div className={`p-8 ${
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-4xl font-extrabold text-white">{role.fee}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8">
                    ...
                    {role.details.map((detail, idx) => (
                      <div key={idx} className="flex items-center mb-3">
                        <div className={`w-2 h-2 rounded-full mr-2 ${
                          index === 0 ? 'bg-[#991c1c]' : index === 1 ? 'bg-[#991c1c]' : 'bg-[#991c1c]'
                        }`}></div>
                  ...
                  <div className="border-t border-gray-200 pt-6 mb-6">
                    <h4 className="font-semibold text-gray-900 mb-3">Committees Access:</h4>
                    <div className="grid grid-cols-2 gap-2">
                      {role.committees.map((committee, idx) => (
                        <div key={idx} className="flex items-center">
                          <svg className={`w-4 h-4 mr-2 ${
                            index === 0 ? 'text-[#991c1c]' : index === 1 ? 'text-[#991c1c]' : 'text-[#991c1c]'
