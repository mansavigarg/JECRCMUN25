...
const AfterMovie = () => {
  ...
  const events = {
    JECRCMUN2024: {
      ...
      infoText: "Join us for the most prestigious Model United Nations conference and be part of the global change-makers community.",
    ...
    ZHS: {
      ...
      infoText: "Experience the convergence of international diplomacy and innovative problem-solving in this landmark event.",
    ...
    VicharVimarsh: {
      ...
      infoText: "An open platform for intellectual dialogue and debate on contemporary socio-political issues that shape our society and future.",
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden opacity-5">
          <div className="absolute -right-40 -top-40 w-80 h-80 rounded-full" style={{ background: colors.primary }}></div>
          <div className="absolute -left-20 bottom-1/4 w-64 h-64 rounded-full" style={{ background: colors.primary }}></div>
        </div>
        
        {/* Top section with join text */}
        <motion.div variants={itemVariants} className="text-center mb-4 sm:mb-6">
          <span className="font-semibold text-sm sm:text-base" style={{ color: colors.primary }}>Join JECRC MUN 2025</span>
        </motion.div>
          ...
          <div className="inline-flex rounded-full shadow-md bg-gray-100 p-1">
            {Object.keys(events).map((eventKey) => (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                style={{ 
                  backgroundColor: activeTab === eventKey ? colors.primary : 'transparent',
                }}
              >
                {activeTab === eventKey && (
                  <motion.span 
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="text-center mb-5 sm:mb-6">
              ...
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold mt-1 sm:mt-2" style={{ color: colors.primary }}>
            ...
            <motion.div 
              ...
              className="relative rounded-lg overflow-hidden mx-auto max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl"
              style={{
                  ...
                  <>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <motion.div 
                        ...
                        style={{ 
                          ...
                          boxShadow: "0 10px 15px -3px rgba(153, 28, 28, 0.3), 0 4px 6px -2px rgba(153, 28, 28, 0.15)"
                        }}
                      ...
                      >
                        <svg className="w-5 h-5 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white ml-0.5 sm:ml-1" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5">
                      <div className="flex flex-col sm:flex-row sm:items-end justify-between">
                        <div>
                          <h3 className="text-base sm:text-lg lg:text-xl font-bold tracking-wide text-white">{events[activeTab].tagline}</h3>
                          <p className="text-sm lg:text-base text-white opacity-90 mt-1">{events[activeTab].description}</p>
                        </div>
                      </div>
                    </div>
                  </>
            ...
            >
              ...
              >
                <motion.button
                  ...
                  style={{ 
                    backgroundColor: colors.primary,
                    boxShadow: "0 4px 6px -1px rgba(153, 28, 28, 0.3), 0 2px 4px -1px rgba(153, 28, 28, 0.15)"
                  }}
                >
