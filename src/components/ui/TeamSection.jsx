    ...
    <div className="w-full py-2 sm:py-10">
      {teams.map((team, teamIndex) => {
        ...
        if (numMembers === 1) {
          ...
          gridClass =
            "grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-5 px-1 place-items-center";
        } else {
          // For 3 or more members, use grid with adjusted last row
          gridClass =
            "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-5 px-1";
            ...
            <div className={gridContainerClass}>
              <div className={gridClass}>
                {team.members.map((member, memberIndex) => {
                  ...
                  let cardClass =
                    "flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden w-full sm:w-[300px] lg:w-[350px] transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1 mx-auto mb-4";
